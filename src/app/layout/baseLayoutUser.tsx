...
export function BaseLayoutUser({ children, isLogin, imageEmployee }: {
	children: ReactNode,
	isLogin: boolean,
	...
	return ( <>
			<div
				className={ `navbar bg-base-300/70 fixed top-0 start-0 z-20 w-full transition-transform duration-300 ${
							...
							<div className="avatar">
								...
								<div className="w-24 rounded-full">
									<picture>
										<img
											alt={ 'avatar' }
											src={ imageEmployee ?? "/person_default.webp" }
										/>
									</picture>
								</div>
							</div>
