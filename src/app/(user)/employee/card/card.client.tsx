                ...
                <div className="card card-compact bg-white h-[10.2cm] w-[6.5cm] shadow-lg print:shadow-none">
                    <div className="card-body ">
                        ...
                        <div className="text-center ">
                            <h2 className="text-lg font-bold text-gray-800 capitalize">{ user.name }</h2>
                    ...
                    <div className="card-body ">
                        ...
                        <div className=" text-[9px] text-gray-600 space-y-2">
                            <div className=" ">
                                ...
                                <p className=" mt-2">
                                    Menjadi perusahaan terkemuka yang inovatif dan berdaya saing global dalam
                                    menciptakan
                                    solusi
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside  mt-2 space-y-2">
                                    <li>Mengembangkan produk dan layanan berkualitas tinggi yang berorientasi pada
                                        kepuasan
                                        pelanggan.
                                    </li>
                                    <li>Meningkatkan kompetensi sumber daya manusia untuk menghadapi tantangan global.
                                    </li>
                                    <li>Berinovasi dalam teknologi dan proses bisnis guna menciptakan efisiensi dan
                                        nilai
                                        tambah.
                                    </li>
