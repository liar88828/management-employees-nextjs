...
// Create types for the statusEmployee codes and names
...
const dataCode: ErrorStatusCode = 201 // This will NOT work because 499 is not a valid statusEmployee code in errorStatus
